...
Selects Book Metro Ticket.
Chooses Source Station and Destination Station.
Enters Passenger Details.
Fare is calculated automatically.
User submits the request.
Flow Designer creates a database record.
QR Code is generated.
Ticket is successfully created and stored.
